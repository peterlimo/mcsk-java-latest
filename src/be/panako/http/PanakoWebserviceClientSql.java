...
public class PanakoWebserviceClientSql {
    ...
    public static List<SQLFingerprint> deserializeFingerprintsFromJson(String fingerprints){
		JSONArray array = new JSONArray(fingerprints);
		List<SQLFingerprint> fingerprintArray = new ArrayList<SQLFingerprint>();
		for(int i = 0 ; i < array.length();i++){
			...
			fingerprintArray.add(new SQLFingerprint(t1, f1,f1e, t2, f2,f2e));
		}
    ...
    public static String serializeFingerprintsToJson(List<SQLFingerprint> fingerprints) throws JSONException {
