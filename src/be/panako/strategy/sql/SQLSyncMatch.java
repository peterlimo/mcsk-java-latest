...
public class SQLSyncMatch {
	...
	public SQLSyncMatch(String reference, String matchingStream,double startInReference,double stopInReference,double startInMatchingStream,double stopInMatchinStream,double score,double roughOffset,double refinedOffset){
