...
public interface Storage {
	...
	public abstract List<SQLFingerprintQueryMatch> getMatches(
			List<SQLFingerprint> fingerprints, int size);

	public abstract float addFingerprint(HashSet<int[]> fftFingerprintStore);
